		...
		<div class="grid_3_4">
			<ul class="ui-form">
				...
				<li class="form-group addvote" style="display:none;" >
					...
					<div class="checkbox">
						<label class="form-check-label"><input class="form-check-input" type="checkbox" name="allow_m_vote" id="allow_m_vote" value="1" {allowmvote}><span>Разрешить выбор нескольких вариантов</span></label>
					</div>
				</li>
				[allow-shortstory]
				<li class="form-group imp">
