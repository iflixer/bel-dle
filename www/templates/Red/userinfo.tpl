				...
				<div id="options">
					<div class="addform">
						<ul class="ui-form">
							...
							<li class="form-group">
								<div class="checkbox"><label class="form-check-label"><input class="form-check-input" type="checkbox" name="del_foto" id="del_foto" value="yes"><span>Удалить аватар</span></label></div>
							</li>
							<li class="form-group form-sep"></li>
							<li class="form-group">
						...
						<div class="form_submit">
							<button class="btn btn-big" name="submit" type="submit"><b>Сохранить</b></button> [delete]<b>Удалить аккаунт</b>[/delete]
